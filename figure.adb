...
package body Figure is
   function "<" (Left, Right : in Figure_Access) return Boolean is
   begin
      return Left.all < Right.all;
   end "<";
   
   function "<" (Left, Right : in Figure_Type) return Boolean is
   begin
      return Volume(Left.Shape.all) < Volume(Right.Shape.all);
   end "<";
